...
const tagVariants = cva("inline-flex self-start items-center justify-center whitespace-nowrap border", {
  variants: {
    tone: {
      blue: "border-transparent bg-[rgba(24,220,255,0.2)] text-[#337aff]",
      white: "border-[#dddddd] bg-white text-[#737373]",
    },
    size: {
      large: "",
      small: "",
...
const tagTextVariants = cva("whitespace-nowrap", {
  variants: {
    tone: {
      blue: "font-semibold text-[#337aff]",
      white: "font-medium text-[#737373]",
    },
    size: {
...
const alarmIconVariants = cva("shrink-0", {
  variants: {
    size: {
      large: "size-6",
      small: "size-5",
...
const AlarmIcon = ({ size = "large" }: AlarmIconProps) => {
  if (size === "small") {
    return (
      ...
      >
        <path d="M5.55539 5L4.1665 6.38889" stroke="#337AFF" strokeLinecap="round" strokeWidth="1.66667" />
        <path d="M15.2776 5L16.6665 6.38889" stroke="#337AFF" strokeLinecap="round" strokeWidth="1.66667" />
        <path
          clipRule="evenodd"
  ...
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <path d="M6.66667 6L5 7.66667" stroke="#337AFF" strokeLinecap="round" strokeWidth="1.66667" />
      <path d="M18.3333 6L20 7.66667" stroke="#337AFF" strokeLinecap="round" strokeWidth="1.66667" />
      <path
