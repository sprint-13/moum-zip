...
export const SearchHero = ({ desktopSearchBar }: SearchHeroProps) => {
  return (
    <section className="relative w-full min-w-116 bg-accent sm:overflow-hidden sm:rounded-[2rem]">
      <picture className="block aspect-375/192 w-full min-w-116 bg-muted sm:aspect-696/244 lg:aspect-1280/244">
      ...
      <div className="pointer-events-none absolute inset-0 z-10">
        <div className="flex h-full w-full min-w-116 items-center px-4 py-8 sm:px-10 sm:py-8 lg:px-14">
